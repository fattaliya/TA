                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-11">
                                    ...
                                    {{-- <a href="/admin/peminjaman/reportPeminjaman" class="btn btn-md btn-block btn-success"><i class="fa fa-print"></i> Print</a> --}}
                                </div>
                                <div class="col-md-1">
                         ...
                         <thead>
                                ...
                                <tr>
                                    ...
                                    <td>{{$data->status_peminjaman}} --}}
                                        ...
                                        <a href="/admin/peminjaman/detail/{{$data->id}}" class="btn btn-sm btn-primary"><i class="bx bxs-show"></i></a><br><br>
                                ...
                                <td class="text-center">
                                    ...
                                    {{-- <a href="/admin/peminjaman/detail/{{$data->id}}" class="btn btn-sm btn-primary"><i class="bx bxs-show"></i></a>
                                    <a href="/admin/peminjaman/getKehilangan/{{$data->id}}" class="btn btn-sm btn-secondary"><i class="bx bx-bell-minus"></i></a><br><br> --}}
